          ...
          <Label className="flex items-center gap-2 text-sm text-zinc-300 font-bold">
            ...
            <Button
              ...
              className={
                ...
                (automation.enabled === 1 ? "bg-emerald-500 hover:bg-emerald-500" : "bg-line hover:bg-line")
              }
            >
              <span
                className={
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="border border-line rounded-full px-3 py-2 text-sm bg-card"
              >
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-line">
          ...
          {automation.kind === "seasonal" && (
            <Button
              ...
              className="h-auto text-sm bg-emerald-600 hover:bg-emerald-700 disabled:bg-line-strong text-white rounded-full px-5 py-2 font-bold"
              title={
                automation.enabled !== 1
                  ? "Enable to send"
