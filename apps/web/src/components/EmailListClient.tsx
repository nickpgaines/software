...
export default function EmailListClient() {
  ...
  return (
    <div className="px-4 md:px-10 pt-[calc(env(safe-area-inset-top)+1rem)] md:pt-10 pb-[calc(3.75rem+env(safe-area-inset-bottom))] md:pb-10 space-y-8">
            ...
            <Table>
              <TableHeader className="bg-black [&_tr]:border-b [&_tr]:border-line">
                <TableRow className="hover:bg-transparent">
                  ...
                  <TableHead className="h-auto px-4 py-2 text-xs font-bold text-zinc-500">Subject</TableHead>
                  <TableHead className="h-auto px-4 py-2 text-xs font-bold text-zinc-500">Audience</TableHead>
                  <TableHead className="h-auto px-4 py-2 text-xs font-bold text-zinc-500">Recipients</TableHead>
                  <TableHead className="h-auto px-4 py-2 text-xs font-bold text-zinc-500">Delivered</TableHead>
