...
export default function LoginForm({ signupPrompt }: { signupPrompt: string }) {
  return (
    <Suspense fallback={null}>
      <LoginPageInner signupPrompt={signupPrompt} />
    </Suspense>
  );
}

function LoginPageInner({ signupPrompt }: { signupPrompt: string }) {
