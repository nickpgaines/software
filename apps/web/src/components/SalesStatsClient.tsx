      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        >
          <Button
            ...
            className="h-auto px-3.5 py-1 rounded-full text-[11.5px] font-extrabold hover:bg-transparent"
            style={{
              background: view === "sales" ? PULSE.text : "transparent",
              color: view === "sales" ? PULSE.bg : PULSE.textMuted,
            }}
          >
            Sales
          </Button>
          <Button
            ...
            className="h-auto px-3.5 py-1 rounded-full text-[11.5px] font-extrabold hover:bg-transparent"
            style={{
              background: view === "tech" ? PULSE.text : "transparent",
              color: view === "tech" ? PULSE.bg : PULSE.textMuted,
            }}
          >
            Tech
          </Button>
