...
// P13 — Centered with margin · KPIs ABOVE chart · Pipeline + Activity below.
// Header → KPI strip (small) → chart hero → 3-up (Schedule/Inbox/Tasks) →
// 2-up (Pipeline/Activity). max-w-6xl gives breathing room on the sides.
export default function DashboardView({
  ...
  return (
    <div style={{ background: PULSE.bg, color: PULSE.text }} className="min-h-screen">
      <PulsePreviewBar active="13" group={GROUP} />
      <PulseSidebar
        homeSlug="concept-pulse-13"
        initials={initials}
        variantLabel="Owner"
        variantSlug="13"
        style="sectioned"
