...
export const config = {
  matcher: [
    "/((?!_next/|favicon.ico|privacy|terms|api/login|api/signup|api/auth/|api/messages/webhook|api/voice/outbound|api/voice/status|api/voice/recording|api/email/unsubscribe|api/stripe/webhook|invoices/pay/|api/invoices/pay/).*)",
  ],
};
